...
const Weather = ({data}) => {
  ...
  return (
    ...
    <div className='relative flex flex-col justify-start max-w-[600px] w-full h-[90vh] m-auto p-4 text-gray-300 z-10'>
      <div className='bg-black/50 relative p-8 rounded-md '>
        <p className='text-2xl text-center pb-6'>Weather in {data.name}</p>
        <div className='flex justify-between text-center'>
        <div>
            <p className='font-bold text-2xl'>{data.main.temp.toFixed(0)}&#176;</p>
